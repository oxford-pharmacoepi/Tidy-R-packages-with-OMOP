...
Note that by default tests will be ran in 2 runners, but you can increase that number setting an environment option `TESTTHAT_CPUS`, see: <https://testthat.r-lib.org/articles/parallel.html>.
:::
